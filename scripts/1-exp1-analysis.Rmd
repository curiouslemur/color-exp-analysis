...
xUs <- getXvalues_opt(usdf_agg, concept_pairs, color_pairs, a_us) %>% mutate(deltaX = (xbar1 + xbar4) - (xbar2 + xbar3))
...
i.e comparing delatS values when using alpha_ng vs alpha_both
