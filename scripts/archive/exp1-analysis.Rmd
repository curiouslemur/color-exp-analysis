...
```{r analysis weiter}
# TODO: a scatterplot of xaxis min deltaS, yaxis is max deltaS
# scatterplot shows the number of concepts we find for different combination of min,max deltaS
