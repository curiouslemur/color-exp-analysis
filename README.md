# Analysis folder for the color experiment

## Scripts
```scripts/exp1-analysis-2026.R``` has the latest version of the analysis steps with additional comments on most lines
